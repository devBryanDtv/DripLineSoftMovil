...
class PerfilNegocioFragment : Fragment(), View.OnTouchListener {
    ...
    private var _binding: FragmentPerfilNegocioBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPerfilNegocioBinding.inflate(inflater, container, false)
    ...
    private fun configurarBotones() {
        agregarAnimacion(binding.cardVerPerfil) {
            findNavController().navigate(R.id.action_perfilNegocioFragment_to_verPerfilNegocioFragment)
        }

        agregarAnimacion(binding.cardCambiarContrasena) {
            findNavController().navigate(R.id.action_perfilNegocioFragment_to_cambiarContrasenaNegocioFragment)
        }
